...
<?php
	...
	//get total record
	$qryTotal = "SELECT count(*) total FROM produks WHERE 0=0 ".$search." ";
	...
	$resQry = "SELECT a.*, 
		...
		FROM produks a WHERE 0=0 ".$search." 
...
<a class="addButton button" href="?p=addProducts" title="Add New Record">Tambah Baru</a>
