...
<?php
	if($_POST){
		...
		$Qry = "INSERT INTO produks(kode, kategori_id, nama, keterangan_singkat, 
...
<form action="" method="post" enctype="multipart/form-data" name="formContent" id="formContent" onsubmit="tinymce.triggerSave(); return validateForm('formContent')">
  ...
  <p>&nbsp;</p>
  <hr />
  <input type="button" value="Cancel" class="button" onclick="window.location='index.php?p=products';" />
